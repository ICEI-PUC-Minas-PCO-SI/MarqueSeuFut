...
namespace MarqueSeuFut.Controllers
{
    public class JogadoresController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Jogadores.Include(j => j.Posicao);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Numero,PosicaoId")] Jogador jogador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Numero,PosicaoId")] Jogador jogador)
        {
            if (id != jogador.Id)
            {
                return NotFound();
